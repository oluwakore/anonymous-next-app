import { THERAPISTS_LIST_REQUEST, THERAPISTS_LIST_SUCCESS, THERAPISTS_LIST_FAIL, THERAPISTS_BOOKING_REQUEST, THERAPISTS_BOOKING_SAVE_THERAPIST_ID, THERAPISTS_BOOKING_SAVE_PLAN_ID, THERAPISTS_BOOKING_SAVE_RESERVATION_ID,
  THERAPISTS_BOOKING_SAVE_REFERENCE_ID,
  THERAPISTS_BOOKING_SAVE_SESSION_METADATA  } from "../../actions/actiontypes";
...
export const therapistBookingIdReducer = (state = { therapistId: null, planId: null, reservationId: null, referenceId: null, sessionData: null , loading: false }, action) => {
  switch (action.type) {
