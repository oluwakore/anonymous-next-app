import {STORY_DETAIL_SUCCESS, STORY_DETAIL_FAIL, STORY_DETAIL_REQUEST, SAVE_STORY_ID, STORY_STORY_REQUEST} from '../../actions/actiontypes'
...
export const storyIdReducer = (state = { id: null, loading: false }, action) => {
  switch (action.type) {
