...
function AppointmentDetails() {
  ...
  // gets user details and extracts the appiontment  
      ...
      {loading ? (
        ...
        >
          ...
          >
            ...
            <p className={styles.linkDesc}>Fetching appointment details...</p>
          </div>
        </div>
      ) : (
        <div className={styles.subContainer}>
          <TherapistDetails
            therapistName={appointmentDetail?.name}
            therapistImg={appointmentDetail?.image}
            therapistRating={appointmentDetail?.averageRating}
            sessionStatus={paymentStatus}
            availableTimes={appointmentDetail?.availableTimes}
          />
        </div>
      )}
    </div>
