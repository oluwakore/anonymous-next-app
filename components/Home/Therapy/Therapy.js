    ...
    <div className={styles.therapyContainer}>
      <div className={styles.therapyMainpart}>
        <div className={styles.therapyDesc}>
          <h1>Speak to a Therapist</h1>
          <p>
            We are here to serve and meet your needs with professional and
            experienced therapists at your convenience. Your identity is a
            choice to reveal or conceit, our aim is to meet your need and get
            through your hurdles with you. Your healing matters to us.
          </p>
